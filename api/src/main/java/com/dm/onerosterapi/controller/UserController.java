...
public class UserController {
    ...
    @ResponseBody
    public List<?> getClassesForUser(@PathVariable("id") String id) throws ClassOfCourseNotFoundException, UserNotFoundException {
        return classService.getClassesByUser(id);
    }

    @RequestMapping(value = "/students/{id}/classes", method = RequestMethod.GET)
    @ResponseBody
    public List<?> getClassesForStudent(@PathVariable("id") String id) throws ClassOfCourseNotFoundException, UserNotFoundException {
        return classService.getClassesByStudent(id);
    }

    @RequestMapping(value = "/teachers/{id}/classes", method = RequestMethod.GET)
    @ResponseBody
    public List<?> getClassesForTeachers(@PathVariable("id") String id) throws ClassOfCourseNotFoundException, UserNotFoundException {
